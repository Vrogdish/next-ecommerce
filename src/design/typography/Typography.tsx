...
export default function Typography({
  ...
  switch (variant) {
    ...
    case "h1":
      variantStyle = playfair.className;
      variantSize =
        "text-5xl md:text-7xl lg:text-9xl  tracking-widest leading-tight ";
      variantWeight = "font-bold";
      break;
    case "h2":
      variantStyle = playfair.className;
      variantSize = "text-2xl md:text-3xl tracking-widest ";
      variantWeight = "font-bold";
      break;
    case "h3":
      variantStyle = playfair.className;
