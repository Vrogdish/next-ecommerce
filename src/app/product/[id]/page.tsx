...
export default function Product({ params }: { params: { id: number } }) {
  ...
  useEffect(() => {
    ...
    return (
      <main>
        <div onClick={router.back} className="my-20 flex gap-4 items-center px-10 cursor-pointer">
        ...
        <div className=" mx-auto max-w-screen-lg">
          <div className="flex flex-col lg:flex-row gap-28 items-center lg:items-end  mb-20 ">
            ...
            <div className="px-6 md:w-1/2">
              ...
              <Typography variant="caption" component="p" color="red" className=" text-right my-20">
              {product.price} €
              </Typography>
